...
public class LinkedInApplyAppService : ILinkedInApplyAppService
{
    private readonly IChatGptService _chatGptService;
    private readonly ILogger<LinkedInApplyAppService> _logger;
    private readonly int _maxFormSteps;

    public LinkedInApplyAppService(
        IChatGptService chatGptService,
        IOptions<JobSearchSettings> settings,
        ILogger<LinkedInApplyAppService> logger)
    {
