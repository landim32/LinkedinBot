...
public class LinkedInSearchAppService : ILinkedInSearchAppService
{
    private readonly JobSearchSettings _settings;
    private readonly ILogger<LinkedInSearchAppService> _logger;

    public LinkedInSearchAppService(IOptions<JobSearchSettings> settings, ILogger<LinkedInSearchAppService> logger)
    {
